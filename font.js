{
    ...
    r0_xn$createglyph$7Hrq('S', function _r0_t22() {
        var r49_xn$setwidth$9Jrj, r49_xn$assignunicode$7Hrq, r49_xn$startfrom$1aao, r49_xn$lineto$5sIl, r49_xn$curveto$1aao, r49_xn$cubicto$1aao, r49_xn$putshapes$9Jrj, r49_xn$reverselast$3qIs, r49_xn$includeglyph$3qIs, r49_slope, r49_bowltop, r49_strokemiddle, r49_bowlbottom, _r49_t0;
        _r49_t0 = this;
        ...
        r49_xn$assignunicode$7Hrq('S');
        r49_slope = 0.11;
        r49_bowltop = new r0_Stroke();
        r49_bowltop['start-from'](r0_RIGHTSB - r0_SB * 0.1, r0_CAP - r0_HOOK)['set-width'](r0_STROKE, 0)['curve-to'](r0_MIDDLE + r0_KAPPA_HOOK * (r0_MIDDLE - r0_para['sb']), r0_CAPO, r0_MIDDLE, r0_CAPO)['cubic-to'](r0_SB + (1 - r0_BKAPPA) * (r0_WIDTH / 2 - r0_SB), r0_CAPO, r0_SB, r0_CAP - r0_COBKAPPA * r0_SMOOTH, r0_SB, r0_CAP_SMOOTH);
        r49_strokemiddle = new r0_Stroke();
        r49_strokemiddle['start-from'](r0_SB + r0_STROKE / 2, r0_CAP_SMOOTH)['set-width'](r0_STROKE / 2, r0_STROKE / 2)['curve-to'](r0_SB + r0_STROKE / 2, (0.5 + r49_slope) * r0_CAP + 2 * r49_slope * r0_CAP / (0.4 * r0_WIDTH) * (0.3 * r0_WIDTH - r0_SB - r0_STROKE / 2), 0.3 * r0_WIDTH, (0.5 + r49_slope) * r0_CAP)['line-to'](0.7 * r0_WIDTH, (0.5 - r49_slope) * r0_CAP)['curve-to'](r0_RIGHTSB - r0_STROKE / 2, (0.5 - r49_slope) * r0_CAP - 2 * r49_slope * r0_CAP / (0.4 * r0_WIDTH) * (0.3 * r0_WIDTH - r0_SB - r0_STROKE / 2), r0_RIGHTSB - r0_STROKE / 2, r0_SMOOTH);
        r49_bowlbottom = new r0_Stroke();
        r49_bowlbottom['start-from'](r0_RIGHTSB, r0_SMOOTH)['set-width'](0, r0_STROKE)['cubic-to'](r0_RIGHTSB, r0_COBKAPPA * r0_SMOOTH, r0_MIDDLE + r0_BKAPPA * (r0_RIGHTSB - r0_MIDDLE), r0_O, r0_MIDDLE, r0_O)['curve-to'](r0_MIDDLE - r0_KAPPA_HOOK * (r0_MIDDLE - r0_para['sb']), r0_O, r0_SB * 1.1, r0_HOOK);
        r49_xn$putshapes$9Jrj(r49_bowltop['form-stroke']());
        r49_xn$putshapes$9Jrj(r49_strokemiddle['form-stroke']());
        r49_xn$putshapes$9Jrj(r49_bowlbottom['form-stroke']());
        return void 0;
    });
    r0_xn$createglyph$7Hrq('dollar', function _r0_t23() {
        ...
        r51_xn$assignunicode$7Hrq('$');
        r51_xn$putshapes$9Jrj(r0_glyphs['S']['contours']);
        r51_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_MIDDLE, r0_CAP)['set-width'](r0_HALFSTROKE, r0_HALFSTROKE)['line-to'](r0_MIDDLE, r0_CAP - r0_DESCENDER / 2)['form-stroke']());
        r51_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_MIDDLE, r0_DESCENDER / 2)['set-width'](r0_HALFSTROKE, r0_HALFSTROKE)['line-to'](r0_MIDDLE, 0)['form-stroke']());
        return void 0;
    });
    r0_xn$createglyph$7Hrq('o', function _r0_t24() {
        ...
        r53_xn$assignunicode$7Hrq('o');
        r53_xn$putshapes$9Jrj([
    ...
    r0_xn$createglyph$7Hrq('o.left', function _r0_t25() {
        var r55_xn$setwidth$9Jrj, r55_xn$assignunicode$7Hrq, r55_xn$startfrom$1aao, r55_xn$lineto$5sIl, r55_xn$curveto$1aao, r55_xn$cubicto$1aao, r55_xn$putshapes$9Jrj, r55_xn$reverselast$3qIs, r55_xn$includeglyph$3qIs, _r55_t0;
        _r55_t0 = this;
        ...
        r55_xn$putshapes$9Jrj([
            r0_ORing(r0_XO, r0_O, r0_SB + r0_STROKE / 2, r0_RIGHTSB, r0_SMALLSMOOTH),
            r0_ORing(r0_XO - r0_STROKE, r0_O + r0_STROKE, r0_SB + r0_STROKE, r0_RIGHTSB - r0_STROKE, r0_SMALLSMOOTH - r0_STROKE)
        ]);
        r55_xn$reverselast$3qIs();
        return void 0;
    });
    r0_xn$createglyph$7Hrq('o.right', function _r0_t26() {
    ...
    r0_xn$createglyph$7Hrq('p', function _r0_t27() {
        ...
        r59_xn$assignunicode$7Hrq('p');
        r59_xn$putshapes$9Jrj(r0_glyphs['o.left']['contours']);
        r59_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_SB, r0_XH)['set-width'](r0_STROKE, 0)['line-to'](r0_SB, r0_DESCENDER)['form-stroke']());
        return void 0;
    });
    r0_xn$createglyph$7Hrq('b', function _r0_t28() {
        ...
        r61_xn$assignunicode$7Hrq('b');
        r61_xn$putshapes$9Jrj(r0_glyphs['o.left']['contours']);
        r61_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_SB, 0)['set-width'](0, r0_STROKE)['line-to'](r0_SB, r0_CAP)['form-stroke']());
        return void 0;
    });
    r0_xn$createglyph$7Hrq('q', function _r0_t29() {
        ...
        r63_xn$assignunicode$7Hrq('q');
        r63_xn$putshapes$9Jrj(r0_glyphs['o.right']['contours']);
        r63_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_RIGHTSB, r0_XH)['set-width'](0, r0_STROKE)['line-to'](r0_RIGHTSB, r0_DESCENDER)['form-stroke']());
        return void 0;
    });
    r0_xn$createglyph$7Hrq('d', function _r0_t30() {
        ...
        r65_xn$assignunicode$7Hrq('d');
        r65_xn$putshapes$9Jrj(r0_glyphs['o.right']['contours']);
        r65_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_RIGHTSB, 0)['set-width'](r0_STROKE, 0)['line-to'](r0_RIGHTSB, r0_CAP)['form-stroke']());
        return void 0;
    });
    r0_xn$createglyph$7Hrq('g', function _r0_t31() {
        var r67_xn$setwidth$9Jrj, r67_xn$assignunicode$7Hrq, r67_xn$startfrom$1aao, r67_xn$lineto$5sIl, r67_xn$curveto$1aao, r67_xn$cubicto$1aao, r67_xn$putshapes$9Jrj, r67_xn$reverselast$3qIs, r67_xn$includeglyph$3qIs, r67_MODDLE, _r67_t0;
        _r67_t0 = this;
        ...
        r67_xn$assignunicode$7Hrq('g');
        r67_xn$putshapes$9Jrj([
        ...
        r67_xn$reverselast$3qIs();
        r67_xn$putshapes$9Jrj(new r0_Stroke()['start-from'](r0_MIDDLE, r0_XH * 0.4)['set-width'](0, r0_STROKE * 0.75)['arc-hv-to'](r0_SB * 1.5 + r0_STROKE, (r0_O - r0_DESCENDER * 0.85 + r0_XH * 0.4) / 2)['set-width'](0, r0_STROKE)['arc-vh-to'](r0_MIDDLE + r0_DESCENDER * 0.15, r0_O - r0_DESCENDER * 0.85)['line-to'](r0_MIDDLE - r0_DESCENDER * 0.15, r0_O - r0_DESCENDER * 0.85)['arc-hv-to'](r0_RIGHTSB - r0_O * 2, 0)['arc-vh-to'](r0_MIDDLE, r0_DESCENDER + r0_O)['arc-hv-to'](r0_SB, r0_DESCENDER * 0.1)['arc-vh-to'](r0_MIDDLE + r0_DESCENDER * 0.15, r0_O - r0_DESCENDER * 0.85)['form-stroke']());
        r67_xn$startfrom$1aao(r0_RIGHTSB, r0_XH);
        r67_xn$lineto$5sIl(r0_RIGHTSB, r0_XH - r0_STROKE);
        r67_xn$lineto$5sIl(r0_MIDDLE, r0_XH - r0_STROKE - r0_O);
        r67_xn$lineto$5sIl(r67_MODDLE, r0_XH);
        return void 0;
    });
    r0_xn$createglyph$7Hrq('x', function _r0_t32() {
        var r69_xn$setwidth$9Jrj, r69_xn$assignunicode$7Hrq, r69_xn$startfrom$1aao, r69_xn$lineto$5sIl, r69_xn$curveto$1aao, r69_xn$cubicto$1aao, r69_xn$putshapes$9Jrj, r69_xn$reverselast$3qIs, r69_xn$includeglyph$3qIs, r69_TURN, r69_barone, r69_bartwo, _r69_t0, _r69_t1;
        _r69_t0 = this;
        ...
        r69_xn$assignunicode$7Hrq('x');
        r69_TURN = r0_XH * 0.1;
        r69_barone = new r0_Stroke()['start-from'](r0_SB + r0_HALFSTROKE, 0)['set-width'](r0_HALFSTROKE, r0_HALFSTROKE)['cubic-to'](r0_SB + r0_HALFSTROKE, r69_TURN + 0.17 * (r0_XH - r69_TURN), r0_RIGHTSB - r0_HALFSTROKE, r0_XH - r69_TURN - 0.17 * (r0_XH - r69_TURN), r0_RIGHTSB - r0_HALFSTROKE, r0_XH)['form-stroke']();
        r69_bartwo = [r69_barone[0]['map'](function _r69_t1(r70_pt) {
                var r70_pt;
                return {
                    'x': r0_WIDTH - r70_pt['x'],
                    'y': r70_pt['y'],
                    'onCurve': r70_pt['onCurve'],
                    'cubic': r70_pt['cubic']
                };
            })['reverse']()];
        r69_xn$putshapes$9Jrj(r69_barone);
        r69_xn$putshapes$9Jrj(r69_bartwo);
        return void 0;
    });
