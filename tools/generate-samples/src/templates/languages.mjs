...
const languages = [
	{
		lang: "English",
		sample: "Shaw, those twelve beige hooks are joined if I patch a young, gooey mouth.",
	},
	{
		lang: "IPA",
		sample: "[liə̯bə̆ ɡʷɯ̹ʔ̚ daŋ˕ sŋə̆r̥ra] [ʔɹie˦ na˦ ɡɨ˨ tɕie˦] [ʔɣɛw˦˨ tɕi˦˨ ʔɨwk˦ ʔɨwk˦] [jaw⁴ tsɨ³ tʂɨ¹ ʋu² tʂi¹]",
		localeId: "und-fonipa",
	},
	{
		lang: "Armenian",
		sample: "Չին ֆիզիկոսը օճառաջուր ցողելով բժշկում է հայ գնդապետի փքված ձախ թևը։",
	},
	{
		lang: "Azerbaijani",
	...
	{
		lang: "Belarusian",
		sample: "У Іўі худы жвавы чорт у зялёнай камізэльцы пабег падʼесці фаршу з юшкай.",
	},
	{
		lang: "Breton",
		sample: "Yec’hed mat Jakez ! Skarzhit ar gwerennoù-mañ, kavet e vo gwin betek fin ho puhez.",
	},
	{
		lang: "Bulgarian",
	...
	{
		lang: "Catalan",
		sample: "«Dóna amor que seràs feliç!». Això, iŀlús company geniüt, ja és un lluït rètol blavís d’onze kWh.",
	},
	{ lang: "Croatian", sample: "Gojazni đačić s biciklom drži hmelj i finu vatu u džepu nošnje." },
	{
		lang: "Czech",
		sample: "Nechť již hříšné saxofony ďáblů rozezvučí síň úděsnými tóny waltzu, tanga a quickstepu.",
	},
	{
		lang: "Danish",
	...
	{
		lang: "Estonian",
		sample: "Põdur Zagrebi tšellomängija-följetonist Ciqo külmetas kehvas garaažis.",
	},
	{
		lang: "Finnish",
	...
	{
		lang: "Maltese",
		sample: "Kien liebes gozz ħwejjeġ u ċraret vera qodma u m’għażluhx fil-pront.",
	},
	{
		lang: "Norwegian",
	...
	{
		lang: "Portuguese",
		sample: "Luís argüia à Júlia que «brações, fé, chá, óxido, pôr, zângão» eram palavras do português.",
	},
	{
		lang: "Romanian",
	...
	{
		lang: "Russian",
		sample: "Широкая электрификация южных губерний даст мощный толчок подъёму сельского хозяйства.",
	},
	{
		lang: "Northern Sámi",
		sample: "Vuol Ruoŧa geđggiid leat máŋga luosa ja čuovžža.",
		localeId: "se",
	},
	{
		lang: "Serbian",
	...
	{
		lang: "Slovak",
		sample: "Kŕdeľ šťastných ďatľov učí pri ústí Váhu mĺkveho koňa obhrýzať kôru a žrať čerstvé mäso.",
	},
	{ lang: "Slovenian", sample: "V kožuščku hudobnega fanta stopiclja mizar." },
	{
		lang: "Spanish",
		sample: "Benjamín pidió una bebida de kiwi y fresa; Noé, sin vergüenza, la más exquisita champaña del menú.",
	},
	...
	{
		lang: "Vietnamese",
		sample: "Do bạch kim rất quý nên sẽ dùng để lắp vô xương.",
		localeId: "vi",
	},
