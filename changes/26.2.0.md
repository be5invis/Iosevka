...
* Swap the sizes of MODIFIER LETTER {REVERSED} GLOTTAL STOP (`U+02C0`..`U+02C1`) with MODIFIER LETTER SMALL REVERSED GLOTTAL STOP (`U+02E4`) to match the sizes of MODIFIER LETTER {REVERSED} GLOTTAL STOP WITH STROKE (`U+107B3`..`U+107B4`).
