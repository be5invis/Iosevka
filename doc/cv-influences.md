...
- `APL form`:
  ...
  ← (`U+2190`), ↑ (`U+2191`), → (`U+2192`), ↓ (`U+2193`), ↕ (`U+2195`), ↖ (`U+2196`), ↘ (`U+2198`), ↙ (`U+2199`), ↥ (`U+21A5`), ↧ (`U+21A7`), ↩ (`U+21A9`), ↫ (`U+21AB`), ↬ (`U+21AC`), ↯ (`U+21AF`), ↻ (`U+21BB`), ⇌ (`U+21CC`), ⇐ (`U+21D0`), ⇡ (`U+21E1`), ∆ (`U+2206`), ∇ (`U+2207`), ∊ (`U+220A`), ∞ (`U+221E`), ∾ (`U+223E`), ⋯ (`U+22EF`), ⌕ (`U+2315`), ⌜ (`U+231C`), ⌝ (`U+231D`), ⌵ (`U+2335`), ⎉ (`U+2389`), ⎊ (`U+238A`), ⎋ (`U+238B`), □ (`U+25A1`), △ (`U+25B3`), ▽ (`U+25BD`), ◇ (`U+25C7`), ○ (`U+25CB`), ◠ (`U+25E0`), ◡ (`U+25E1`), ◫ (`U+25EB`), ◰ (`U+25F0`), ◳ (`U+25F3`), ◴ (`U+25F4`), ◶ (`U+25F6`), ◹ (`U+25F9`), ◿ (`U+25FF`), ☇ (`U+2607`), ⚂ (`U+2682`), ⚇ (`U+2687`), ⤙ (`U+2919`), ⤚ (`U+291A`), ⥊ (`U+294A`)
...
- `cv56`:
  ...
  v (`U+0076`), ʋ (`U+028B`), ʌ (`U+028C`), ͮ (`U+036E`), ᵛ (`U+1D5B`), ᵥ (`U+1D65`), ᶌ (`U+1D8C`), ᶹ (`U+1DB9`), ᶺ (`U+1DBA`), ṽ (`U+1E7D`), ṿ (`U+1E7F`), ⅳ (`U+2173`), ⅴ (`U+2174`), ⅵ (`U+2175`), ⅶ (`U+2176`), ⅷ (`U+2177`), ⒱ (`U+24B1`), ⓥ (`U+24E5`), ⱱ (`U+2C71`), ⱴ (`U+2C74`), 𐞰 (`U+107B0`), 𝐯 (`U+1D42F`), 𝑣 (`U+1D463`), 𝒗 (`U+1D497`), 𝗏 (`U+1D5CF`), 𝘃 (`U+1D603`), 𝘷 (`U+1D637`), 𝙫 (`U+1D66B`), 𝚟 (`U+1D69F`)
