...
- `cv72`:
  ...
  Λ (`U+039B`), Ѧ (`U+0466`), ѧ (`U+0467`), Ѩ (`U+0468`), ѩ (`U+0469`), ᴧ (`U+1D27`), ⷽ (`U+2DFD`), Ꟛ (`U+A7DA`), Ƛ (`U+A7DC`), 𝚲 (`U+1D6B2`), 𝛬 (`U+1D6EC`), 𝜦 (`U+1D726`), 𝝠 (`U+1D760`), 𝞚 (`U+1D79A`)
...
- `cv97`:
  ...
  Є (`U+0404`), Э (`U+042D`), Ѥ (`U+0464`), Ә (`U+04D8`), Ӛ (`U+04DA`), Ӭ (`U+04EC`), € (`U+20AC`), ℈ (`U+2108`)

- `cv98`:

  э (`U+044D`), є (`U+0454`), ѥ (`U+0465`), ә (`U+04D9`), ӛ (`U+04DB`), ӭ (`U+04ED`), ꙴ (`U+A674`), ꚟ (`U+A69F`), 𞁈 (`U+1E048`), 𞁋 (`U+1E04B`)
...
- `cv48`:
  ...
  m (`U+006D`), ɱ (`U+0271`), ͫ (`U+036B`), т (`U+0442`), ҭ (`U+04AD`), ԏ (`U+050F`), ᲅ (`U+1C85`), ᲊ (`U+1C8A`), ᵐ (`U+1D50`), ᵯ (`U+1D6F`), ᶆ (`U+1D86`), ᶬ (`U+1DAC`), ḿ (`U+1E3F`), ṁ (`U+1E41`), ṃ (`U+1E43`), ₘ (`U+2098`), ₥ (`U+20A5`), ⅿ (`U+217F`), ≞ (`U+225E`), ⒨ (`U+24A8`), ⓜ (`U+24DC`), ⷮ (`U+2DEE`), ⷵ (`U+2DF5`), ꚋ (`U+A68B`), ꬺ (`U+AB3A`), 𝐦 (`U+1D426`), 𝑚 (`U+1D45A`), 𝒎 (`U+1D48E`), 𝗆 (`U+1D5C6`), 𝗺 (`U+1D5FA`), 𝘮 (`U+1D62E`), 𝙢 (`U+1D662`), 𝚖 (`U+1D696`), 𞁀 (`U+1E040`)
